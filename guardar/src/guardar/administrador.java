...
public class administrador extends JFrame {
    ...
    private void crear(String usuario) {
        ...
        crear.setBounds(20, 550, 180, 30);
        crear.setBackground(Color.green);
        p1.add(crear);
        ...
        modificar.setBounds(240, 550, 180, 30);
        p1.add(modificar);
        ...
        eliminar.setBounds(460, 550, 180, 30);
        ...
        actualizar.setBounds(680, 550, 180, 30);
        p1.add(actualizar);
        //agregar funcionalidad
        ActionListener accion_actualizar = new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        //Acción del evento
        actualizar.addActionListener(accion_actualizar);
